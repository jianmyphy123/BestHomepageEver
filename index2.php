...
<div class="row">    
  ...
  <div class="row hidden-xs padding-top-30px">
	...
	<div class="col-lg-3 col-md-3 col-sm-3 text-right">
        ...
        <div id="timer">
            <a href="#" data-content="Minutes: <a href='https://www.google.com/search?as_q=5+minute+timer&gws_rd=ssl' target='_blank'>5</a> | <a href='https://www.google.com/search?as_q=5+minute+timer&gws_rd=ssl#q=10+minute+timer' target='_blank'>10</a> | <a href='https://www.google.com/search?as_q=5+minute+timer&gws_rd=ssl#q=15+minute+timer' target='_blank'>15</a> | <a href='https://www.google.com/search?q=30+minute+timer&cad=h' target='_blank'>30</a> | <a href='https://www.google.com/search?as_q=45+minute+timer&gws_rd=ssl#q=45+minute+timer' target='_blank'>45</a><hr>Hours: <a href='https://www.google.com/search?as_q=1+hour+timer&gws_rd=ssl' target='_blank'>1</a> | <a href='https://www.google.com/search?as_q=2+hour+timer&gws_rd=ssl' target='_blank'>2</a> | <a href='https://www.google.com/search?as_q=3+hour+timer&gws_rd=ssl' target='_blank'>3</a>" data-placement="left">Quick Timer</a> <span style="font-size:1.5em;" class="glyphicon glyphicon-time padding-left-3px"></span> 
        </div>   
